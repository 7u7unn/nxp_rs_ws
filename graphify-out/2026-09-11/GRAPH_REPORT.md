...
- robstride_system.hpp
- RobstrideSystem::on_init
...
Cohesion: 0.07
Nodes (28): MotorState, RobotConfig, RobstrideBus, string, unique_ptr, vector, RobstrideSystem, active_ (+20 more)
...
Cohesion: 0.10
Nodes (20): 1. Requirement dan instalasi, 2. Konfigurasi motor, 3. Siapkan dan scan CAN, 4. Baca state tanpa mengaktifkan motor, 5. `ros2_control` standard, 6. Integrasi MoveIt dan RL, 7. Ubah CAN ID satu motor, 8. Jog manual (+12 more)
...
### Community 35 - "TEST"
Cohesion: 0.20
Nodes (13): InitializesAndExportsConfiguredInterfaces, RobstrideSystemTest, export_command_interfaces, export_state_interfaces, on_init, write, HardwareInfo, InterfaceInfo (+5 more)
...
### Community 37 - "FloorSceneNode"
Cohesion: 0.10
Nodes (24): AllowedCollisionMatrix, CollisionObject, size_t, addEntry(), allowPair(), Node, SharedPtr, string (+16 more)
...
Cohesion: 0.33
Nodes (6): ReceivedFrame, communication_type, data, extra_data, length, source_id
...
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: When running MoveIt on hardware, the end effector is shaky despite reaching the goal. Could Kp/Kd cause it?, Source Nodes
...
### Community 66 - "robstride_system.hpp"
Cohesion: 0.50
Nodes (3): atomic, mutex, thread

### Community 67 - "RobstrideSystem::on_init"
Cohesion: 0.50
Nodes (4): load_hardware_config, validate_hardware_joints, HardwareInfo, RobstrideSystem::on_init()
...
- `rs_control/README.md` (4× useful, score=3.898245473) _(code changed — re-verify)_
- `RobstrideSystem::io_loop()` (3× useful, score=2.949569404)
- `Move the physical robot from MoveIt` (2× useful, score=1.953386969) _(code changed — re-verify)_
- `RobstrideSystem::on_activate()` (2× useful, score=1.950313502)
- `rs_bringup.launch.py` (2× useful, score=1.949355242)
...
- **What connects `floor_id_`, `floor_frame_`, `base_link_` to the rest of the system?**
